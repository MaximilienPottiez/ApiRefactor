# Refactor OpenAPI Specification
[![Build Status](https://travis-ci.com/MaximilienPottiez/ApiRefactor.svg?branch=master)](https://travis-ci.com/MaximilienPottiez/ApiRefactor)
## Steps to finish
...
- [Reference Documentation (ReDoc)](https://maximilienpottiez.github.io/ApiRefactor/)
- [SwaggerUI](https://maximilienpottiez.github.io/ApiRefactor/swagger-ui/)
- OpenAPI Raw Files: [JSON](https://maximilienpottiez.github.io/ApiRefactor/openapi.json) [YAML](https://maximilienpottiez.github.io/ApiRefactor/openapi.yaml)
